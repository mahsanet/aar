...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--lib-name",     default="libmasterdns",   help="Output .so filename (without extension)")
    p.add_argument("--aar-name",     default="masterdns",      help="Output .aar filename (without extension)")
    p.add_argument("--package-name", default="com.masterdns",  help="Android package name for AndroidManifest.xml")
    p.add_argument("--build-cmd",    default="./cmd/client",   help="Go build target passed to 'go build'")
